...
class Game():
    ...
    def all_items_dictionary(self):
        all_items =  [butterfly, longsword, greatsword, no_weapon, sword, scythe, fists_of_fury, gnomes, your_hammer]
        all_items_dict = {}
...
class Room():
    def __init__(self, welcome_message, name, exits, items, npcs):
        self.name = name
...
starting_room = Room("You awake in what appears to be a dungeon", "Starting Room", {"south": torture_chamber}, {"Longsword": longsword, "Greatsword": greatsword}, {"Nate": nate, "Alex": alex})
